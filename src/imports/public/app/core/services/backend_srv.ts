...
import { getConfig } from 'imports/public/app/core/config';
import { getSessionExpiry, hasSessionExpiry } from 'imports/public/app/core/utils/auth';
import { loadUrlToken } from 'imports/public/app/core/utils/urlToken';
import { getDashboardAPI } from 'imports/public/app/features/dashboard/api/dashboard_api';
import { DashboardModel } from 'imports/public/app/features/dashboard/state';
import { DashboardSearchItem } from 'imports/public/app/features/search/types';
import { TokenRevokedModal } from 'imports/public/app/features/users/TokenRevokedModal';
import { DashboardDTO, FolderDTO } from 'imports/public/app/types';
