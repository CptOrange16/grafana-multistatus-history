...
import { GRID_CELL_HEIGHT, GRID_CELL_VMARGIN, GRID_COLUMN_COUNT, REPEAT_DIR_VERTICAL } from 'imports/public/app/core/constants';
import { contextSrv } from 'imports/public/app/core/services/context_srv';
import { sortedDeepCloneWithoutNulls } from 'imports/public/app/core/utils/object';
import { isAngularDatasourcePluginAndNotHidden } from 'imports/public/app/features/plugins/angularDeprecation/utils';
import { variableAdapters } from 'imports/public/app/features/variables/adapters';
import { onTimeRangeUpdated } from 'imports/public/app/features/variables/state/actions';
import { GetVariables, getVariablesByKey } from 'imports/public/app/features/variables/state/selectors';
import { CoreEvents, DashboardMeta, KioskMode } from 'imports/public/app/types';
import { DashboardMetaChangedEvent, DashboardPanelsChangedEvent, RenderEvent } from 'imports/public/app/types/events';
